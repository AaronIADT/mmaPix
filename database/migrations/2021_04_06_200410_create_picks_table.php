...
class CreatePicksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('picks', function (Blueprint $table) {
            ...
            $table->bigInteger('fighter_id1')->unsigned()->nullable();
            $table->bigInteger('fighter_id2')->unsigned()->nullable();
            $table->bigInteger('fighter_id3')->unsigned()->nullable();
            $table->bigInteger('fighter_id4')->unsigned()->nullable();
            $table->bigInteger('fighter_id5')->unsigned()->nullable();
            $table->bigInteger('fighter_id6')->unsigned()->nullable();
            $table->bigInteger('fighter_id7')->unsigned()->nullable();
            $table->bigInteger('fighter_id8')->unsigned()->nullable();
            $table->bigInteger('fighter_id9')->unsigned()->nullable();
            $table->bigInteger('fighter_id10')->unsigned()->nullable();
            // $table->string('fight2');
            // $table->string('fight3');
            // $table->string('fight4');
            // $table->string('fight5');
